...
<head>
    ...
    <title>Peraturan Organisasi - YPOK</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <div class="hero-section">
        <h1 class="hero-title">Peraturan Organisasi</h1>
        <p class="hero-subtitle">Pedoman dan peraturan internal YPOK untuk seluruh anggota dan cabang</p>
    </div>

    <div class="container">
        <div class="content-card">
            <h2>📋 Peraturan Organisasi YPOK</h2>
            <p>Halaman ini akan berisi peraturan internal organisasi, pedoman operasional, kode etik, dan standar prosedur yang berlaku di seluruh cabang YPOK se-Indonesia.</p>
