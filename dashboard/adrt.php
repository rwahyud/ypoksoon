...
<body>
    ...
    <div class="hero-section">
        <h1 class="hero-title">ADRT YPOK</h1>
        <p class="hero-subtitle">Anggaran Dasar dan Rumah Tangga Yayasan Pendidikan Olahraga Karate</p>
    </div>

    <div class="container">
        <div class="content-card">
            <h2>📜 ADRT YPOK</h2>
            <p>Halaman ini akan berisi Anggaran Dasar dan Rumah Tangga (ADRT) YPOK yang mengatur struktur organisasi, tujuan, visi-misi, serta tata kelola yayasan secara lengkap.</p>
